...
type SystemSetting struct {
	...
	DataType    string         `gorm:"type:enum('string','integer','decimal','boolean','json');default:'string'" json:"data_type"`
...
type SequenceNumber struct {
	...
	ResetPeriod     string    `gorm:"type:enum('never','daily','monthly','yearly');default:'never'" json:"reset_period"`
